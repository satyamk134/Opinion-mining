...
class UnsupervisedLiu():
    ...
    PATH_TO_LEXICONS = "/home/satyam/zip/opinionproject/opinion_mining/data/Lexicons"
...
def get_sentences_by_aspect(aspect, reviews):
    ...
    # tokenize each sentenceylist= get_sentences(reviews)
    sentences = []
    #
    ...
    #return aspect
    return [sent for sent in tokenized_sentences for aspectitem in aspect if aspectitem in sent]
